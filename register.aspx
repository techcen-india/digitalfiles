                    ...
                    <div class="account-login-inner">
                        <div class="ltn__form-box contact-form-box">
                              ...
                              <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                      <asp:TextBox runat="server" placeholder="Course Name" ID="txtProject" CssClass="form-control" required></asp:TextBox><br />
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                    <asp:TextBox runat="server" placeholder="Enter Details* " ID="txtNotes" CssClass="form-control" required></asp:TextBox><br />
                                        </div>
                                    </div>
